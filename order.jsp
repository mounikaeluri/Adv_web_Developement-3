...
<head>
    ...
    <link rel="stylesheet"type="text/css" href="/jadrn034/proj3/order.css" />
    <script type="text/javascript" src="/jadrn034/proj3/order.js"> </script>
...
<tr> 
    ...
    <td>Price</td>
     ...
     <%   List<String> items=(ArrayList<String>)request.getAttribute("summary");
    	  for(String item : items){
				out.print("<tr>");
				out.print("<td> <img src='http://jadran.sdsu.edu/~jadrn034/proj1/file_upload/_tk_images/"+item.split(",")[0].toLowerCase()+"'/>"+ item.split(",")[1].split(";")[0]+" </td>");
    ...
    <form method="post" action="/jadrn034/servlet/SubmitOrder">
