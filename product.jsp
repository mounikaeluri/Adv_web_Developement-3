...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/jadrn034/proj3/product.css" />
    <link type="text/css" rel="stylesheet" href="/jquery/jquery-ui-1.11.2/jquery-ui.css" />
    <script type="text/javascript" src="/jquery/jquery.js"></script>
    <script type="text/javascript" src="/jquery/jQueryUI.js"></script>
    <script type="text/javascript" src="/jadrn034/proj3/product.js"></script>
...
<body>
    ...
    <div id="header">
        ...
        <h1><a href="http://jadran.sdsu.edu/jadrn034/proj3.html"><img id="logo" src="/jadrn034/proj3/logo.png" /></a></h1>
         ...
         <div id="cart">
            <a href="#"><img id="carticon" src="/jadrn034/proj3/carticon.jpg" />View Cart</a>
        ...
        <div id="checkoutdialog" title="Checkout">
            <form id="checkoutform" method="post" action="/jadrn034/servlet/OrderSummary">
    ...
    <%  List<String> list=(ArrayList<String>)request.getAttribute("product");  %>
        ...
        <div id="product">        
            ...
            <img src="http://jadran.sdsu.edu/~jadrn034/proj1/file_upload/_tk_images/<%= list.get(0).toLowerCase()%>" />
        </div>
