...
$(document).ready(function () {
    ...
    $.get('http://jadran.sdsu.edu/jadrn034/servlet/GetProducts', mapskuToProduct);
...
function updateDisplay() {
    ...
    if (cartArray.length > 0) {
        ...
        for (i = 0; i < cartArray.length; i++) {
            ...
            name.innerHTML ="<img src='http://jadran.sdsu.edu/~jadrn034/proj1/file_upload/_tk_images/"+cartArray[i][0].toLowerCase()+"' />" + product.vendor +" " + product.id;
